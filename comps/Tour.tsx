...
import { DaysTypes } from "../app/property/[id]";
...
export default function Tour() {
  ...
  useEffect(() => {
    ...
    const list: HTMLLIElement[] | any = document.querySelectorAll("ol li");
    ...
    <form className=" w-full">
      ...
      <div>
        <fieldset className=" w-full rounded-sm border-2 h-12 border-sky-200  px-1 my-5">
          ...
          >
            {times.map((each: string, index: number) => {
